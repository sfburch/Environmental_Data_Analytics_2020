...
threeplots <- plot_grid(Tempboxplot, TPboxplot, TNboxplot, Labels = c('Temp', 'TP', 'TN'),
                        label_size = 10, nrow = 3, align = 'h', rel_heights = c(1.25, 1, 1))
...
NIWOneedlesFacets <- 
  ...
  geom_point() +
    facet_wrap(vars(nlcdClass), nrow = 3) #could not find facet wrap
  
print(NIWOneedlesFacets) #said niwoneedfacets not found...
